package com.komyar.demonstration.exception.handle;

import com.komyar.demonstration.dto.response.HttpResponse;
import com.komyar.demonstration.exception.BaseException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<HttpResponse> handleLockedException(LockedException e) {
        return new ResponseEntity<>(HttpResponse.create(PAGE_IS_BANNED.getCode(), PAGE_IS_BANNED.getMessage()), HttpStatus.FORBIDDEN);
    }
